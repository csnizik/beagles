...
Helper.forEach(selectMulti__triggers, function(index, value) {
  ...
  _el.addEventListener('click', function(e){
    ...
    var _check = e.target;
    //var _parent = el.closest('.fds-select-multi');
    var _parent = Helper.getClosest(_el, '.fds-select-multi');
...
function selectMulti__setState(){
  ...
  Helper.forEach(_selectAll, function (index, value) {
    ...
    //var _parent = value.closest('.fds-select-multi');
    var _parent = Helper.getClosest(value, '.fds-select-multi');
