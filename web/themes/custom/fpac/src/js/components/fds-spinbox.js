...
Helper.forEach(spinbox__triggers, function (index, value) {
  ...
  _el.addEventListener('click', function(e){
    ...
    var _component = Helper.getClosest(e.currentTarget, '.fds-spinbox');
    var _target = _component.querySelector('.fds-spinbox__input'); // Which form element in this component will be updated with new value?
    ...
    if (Helper.isIE10Down || Helper.isIE11) { // lazily targeting IE 11 and below. For all I know it works above IE 11
      ...
      if (Helper.hasClass(_el, 'fds-spinbox__btn--decrement')){
